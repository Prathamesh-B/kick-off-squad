      ...
      <div className="mx-auto space-y-4">
        ...
        {profileData?.user?.upiId ? (
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-500">Your UPI Id</p>
              <p className="font-medium">{profileData.user.upiId}</p>
            </div>
          ...
          <Alert variant="warning">
            ...
            <AlertDescription className="mt-1">
              You need to set up your UPI Id before creating events.
              <Button
                variant="link"
          ...
          <Card>
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center">
                  ...
                  <Button
                    ...
                    className="ml-2"
                    type="button"
                    onClick={() => handleSelectChange(12, "maxPlayers")}
                  >
                    12
                  </Button>
                </div>
            ...
            <CardFooter>
              <Button
                type="submit"
                className="w-full"
                disabled={loading || !profileData?.user?.upiId}
              >
      ...
      <Dialog open={showUpiDialog} onOpenChange={setShowUpiDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              To create an event, you need to set up your UPI Id first. This
              helps with managing payments for your events.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
            <Button variant="secondary" onClick={() => setShowUpiDialog(false)}>
              Cancel
            </Button>
            <Button onClick={() => router.push("/profile")}>Set Up UPI</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
    </main>
