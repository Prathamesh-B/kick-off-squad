        ...
        try {
            const response = await fetch("/api/event/create", {
                ...
                body: JSON.stringify({
                    ...
                    creatorId: 1, // Hardcoded for demo purposes; replace with actual user ID
                }),
            })
                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-4">
                                <div className="space-y-2">
                                    ...
                                    <Input id="name" value={formData.name} onChange={handleChange} placeholder="e.g. Saturday League Match" />
                                </div>
                                <div className="space-y-2">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <Input id="location" value={formData.location} onChange={handleChange} placeholder="e.g. MIT Football Ground" />
                                    </div>
                                </div>
                                <div className="space-y-2">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <Input id="maxPlayers" type="number" value={formData.maxPlayers} onChange={handleChange} placeholder="e.g. 12" />
                                    </div>
                                </div>
                                <div className="space-y-2">
